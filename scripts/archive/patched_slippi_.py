# Final clean version: gym removed, JAX fixed, and no invalid RUN commands
import modal
...
def create_slippi_image():
    ...
    image = image.pip_install([
        ...
        "tensorflow==2.13.0", "jax==0.4.13",  # CPU-compatible JAX
...
app = modal.App("slippi-ai-final-fixed")
