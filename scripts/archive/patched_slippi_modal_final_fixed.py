# Final CLEAN version: no Dockerfile-style RUN, fully Modal-compatible
import modal
...
def create_slippi_image():
    ...
    image = image.pip_install([
        ...
        "tensorflow==2.13.0", "jax==0.4.13",  # CPU-compatible
...
python -c "import peppi; print('✅ peppi-py installed and importable')"
    ...
    image = image.run_commands([
        "pip install -r requirements.txt || echo 'Requirements partially installed'",
        "pip install -e . || echo 'Editable install fallback'",
    ])
