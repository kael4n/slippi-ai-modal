# FINAL FINAL version: fully sanitized, no multiline strings or stray RUN/empty lines
import modal
...
def create_slippi_image():
    ...
    image = image.run_commands([
        ...
        f"pip install --no-build-isolation --verbose --timeout=300 "{PEPPI_PY_URL}"",
...
app = modal.App("slippi-ai-strict-clean")
