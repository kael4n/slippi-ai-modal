# FINAL version without emoji to avoid Unicode errors in Windows Python
import modal
...
def create_slippi_image():
    ...
    image = image.run_commands([
        f"source ~/.cargo/env && export PATH='/root/.cargo/bin:$PATH' && pip install --no-build-isolation --verbose --timeout=300 '{PEPPI_PY_URL}'",
...
app = modal.App("slippi-ai-strict-clean-v4")
