# Final v8: move peppi install after python setup to fix missing `python3` error
import modal
...
def create_slippi_image():
    ...
    image = image.run_commands([
        f"python3 -m pip install --no-build-isolation --verbose --timeout=300 '{PEPPI_PY_URL}'",
...
app = modal.App("slippi-ai-strict-clean-v8")
