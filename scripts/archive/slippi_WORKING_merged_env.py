# slippi_WORKING_merged_env.py
# Combined environment + .pkl validation runner using env vars instead of CLI args
...
app = modal.App("slippi-ai-merged-env")
...
def main():
    ...
    if mode == "env":
        ...
        print(f"⚠️ Unknown mode: {mode} (use MODE=env or MODE=pkl)")
