# v10: install peppi-py v0.6.0 manually for slippi-ai compatibility
import modal
...
def create_slippi_image():
    ...
    image = image.run_commands([
        ...
        f"cd {PEPPI_CLONE_PATH} && git checkout tags/{PEPPI_PY_TAG} -b build-branch",
...
app = modal.App("slippi-ai-strict-clean-v10")
