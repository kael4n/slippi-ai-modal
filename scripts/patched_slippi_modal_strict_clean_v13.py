# v13: add `maturin` install to enable peppi-py==0.6.0 build
import modal
...
def create_slippi_image():
    ...
    image = image.run_commands([
        ...
        "python3 -m pip install maturin",  # fix: install maturin before building peppi-py
...
app = modal.App("slippi-ai-strict-clean-v13")
